...
namespace DeadWrongGames.ZModularUI
{
    ...
    {
        /// <summary>
        /// Modular properties can be hierarchical. Nested properties (like <see cref="ModularImageProperties"/> inside <see cref="ModularViewProperties"/>) are recursively loaded and applied.
        /// </summary>
